  ...
  return (
    <div id="inquiry-form" className="bg-[#1A1A1A] rounded-2xl p-8 border border-white/5 mb-16">
      ...
      <form className="space-y-6">
        ...
        <button
          type="button"
          className="w-full md:w-[350px] bg-primary hover:bg-primary/90 text-[#111] font-semibold py-4 px-8 rounded-sm transition-colors text-sm flex mx-auto justify-center mt-8"
        >
          Send Inquiry
        </button>
      </form>
