  ...
  return (
    <div className="bg-[#1A1A1A] rounded-2xl p-8 border border-white/5 mb-8">
      ...
      <div className="border-t border-white/5 pt-6">
        <h4 className="text-[10px] text-white/30 uppercase tracking-widest font-bold mb-4">
          Area of Expertise
        </h4>
        <div className="flex flex-wrap gap-3">
          {item.tags.map((tag) => (
            <span
              key={tag}
              className="px-4 py-1.5 rounded-full border border-primary/20 text-primary text-xs tracking-wide"
            >
              {tag}
            </span>
          ))}
