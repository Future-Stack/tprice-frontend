...
export function VIPBiddingSidebar({
  ...
  const displayedTotal = inclFees ? formattedTotalPayable : formattedPrice;
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`w-10 h-5.5 rounded-full relative transition-all duration-300 cursor-pointer ${
                  inclFees ? "bg-white" : "bg-[#2C2C2E]"
                }`}
                aria-label="Toggle include fees"
              >
                <div
