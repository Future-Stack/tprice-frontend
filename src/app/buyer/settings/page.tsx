  ...
  return (
    <AnimationWrapper>
      <div className="w-full max-w-200 mb-20 lg:mb-0">
        {/* Main Card */}
        <div
          className="bg-[#18181A] rounded-[20px] shadow-[0_0_50px_rgba(231,143,35,0.03)] border border-[#E78F23]/10 md:p-10 p-6 relative overflow-hidden"
          style={{
            boxShadow: "0px 0px 80px 0px rgba(231, 143, 35, 0.05)",
          }}
        >
          <h1 className="text-[28px] md:text-4xl font-medium font-clash text-white mb-10 relative z-10">
            Settings
          </h1>
          ...
          <section className="mb-10 relative z-10">
            ...
            <div className="bg-[#111113] rounded-xl p-4 flex items-center justify-between border border-[#2A2A2C]">
              ...
              <button
                type="button"
                className="px-5 py-2 text-xs font-medium text-gray-400 hover:text-white bg-[#1A1A1C] border border-[#2A2A2C] rounded-lg hover:bg-[#252528] transition-colors shrink-0 cursor-pointer"
              >
                Manage
              </button>
            </div>
          ...
          <section className="mb-10 relative z-10">
            ...
            <form onSubmit={handleProfileSubmit} className="space-y-4">
              <div>
                <label className="block text-[11px] font-medium text-gray-400 mb-1.5 pl-0.5">
                  Name
                </label>
                <input
                  type="text"
          ...
          <section className="mb-10 relative z-10">
            ...
            >
              ...
              <span className="text-xs text-[#E78F23] font-medium">
                {showSecurityForm ? "Cancel" : "Edit"}
              </span>
            </div>
            ...
            {showSecurityForm && (
              <form
                ...
                className="mt-4 space-y-4 bg-[#111113] p-4 rounded-[10px] border border-[#2A2A2C]"
              >
                <div>
                  <label className="block text-[11px] font-medium text-gray-400 mb-1.5 pl-0.5">
                    Current Password
