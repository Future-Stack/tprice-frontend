...
import { SellerUnlimitedPlanCardProps, formatExpiryDate } from "./types";

export function SellerUnlimitedPlanCard({
  price = 399,
  ...
  const planDescription = hasActiveSubscription
    ...
    : description ||
      `Yearly $${price} subscription for unlimited featured placement for all seller listings for 1 year`;
...
export default SellerUnlimitedPlanCard;
