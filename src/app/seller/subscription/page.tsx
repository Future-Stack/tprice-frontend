...
import {
  SellerSubscriptionHeader,
  SellerActiveSubscriptionBanner,
  SellerSubscriptionErrorAlert,
  SellerSubscriptionSkeleton,
  SellerSinglePlanCard,
  SellerUnlimitedPlanCard,
} from "./_components";
...
export default function SellerSubscriptionPage() {
  ...
  return (
    <div className="space-y-10 relative z-0 max-w-6xl mx-auto pb-12">
      <SellerSubscriptionHeader isError={isError} onRefresh={handleRefetch} />
      ...
      {isError && (
        <SellerSubscriptionErrorAlert errorMessage={errorMessage} onReload={handleRefetch} />
      )}
