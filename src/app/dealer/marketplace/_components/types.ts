export const DEALER_CATEGORIES = ["All", "Car", "Yacht", "Jet", "Real Estate", "Watch"];
...
export interface DealerMarketplaceHeaderProps {
  categories: string[];
...
export interface DealerFilterDrawerProps {
  activeCategory: string;
...
export interface DealerMarketplaceGridProps {
  assets: Asset[];
}

export interface DealerAssetCardProps {
  asset: Asset;
}

export const DEALER_MARKETPLACE_ASSETS: Asset[] = [
  {
    id: 1,
    image:
