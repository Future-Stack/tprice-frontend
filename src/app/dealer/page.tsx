  ...
  return (
    <div className="space-y-8 relative z-0">
      ...
      <AnimationWrapper type="fade-down" duration={0.5}>
        <div>
          <h2 className="text-[40px] font-clash font-medium tracking-wide">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <AnimationWrapper type="fade-right" duration={0.6} delay={0.1}>
          <div
            className="bg-foreground p-7 rounded-2xl border border-primary/30 shadow-xl hover:border-[#E78F23]/20 transition-colors"
            style={{
              boxShadow:
