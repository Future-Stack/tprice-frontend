...
import { DealerVIPFilterProps, DEALER_VIP_CATEGORIES } from "./types";
...
function FilterContent(props: DealerVIPFilterProps) {
  const {
    activeCategory,
    setActiveCategory,
    draftFilters,
...
export function DealerVIPFilterDrawer(props: DealerVIPFilterProps) {
...
export default DealerVIPFilterDrawer;
