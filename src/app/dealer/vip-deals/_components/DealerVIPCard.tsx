...
import { DealerVIPCardProps } from "./types";

export function DealerVIPCard({ asset }: DealerVIPCardProps) {
  return (
    <Link href={`/dealer/vip-deals/${asset.id}`} className="block h-full">
