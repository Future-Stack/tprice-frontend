...
const SOCIAL_SVGS = [
  ...
  // X (Twitter)
  <svg key="x" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
    ...
    <footer className="bg-[#050505] text-white pt-24 pb-10 border-t border-white/5">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-20 mb-20">
          ...
          {/* Company Column */}
          <div>
            <h4 className="text-xs font-montserrat font-normal uppercase   mb-10 text-primary">
              COMAPNY
            </h4>
            <ul className="space-y-4">
              {COMPANY_LINKS.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-white/80 text-[13px] font-montserrat hover:text-white transition-colors"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          {/* Quick Links Column */}
          <div>
            <h4 className="text-xs font-normal font-montserrat uppercase   mb-10 text-primary">
              QUICK LINKS
            </h4>
            <ul className="space-y-4">
              {QUICK_LINKS.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-white/80 font-montserrat text-[13px] hover:text-white transition-colors"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          {/* Subscription Column */}
          <div>
            <h4 className="text-xs font-normal uppercase font-montserrat  mb-10 text-primary">
              STAY UPDATED
            </h4>
