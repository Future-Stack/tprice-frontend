          ...
          {isLoading ? (
            ...
            <AnimationWrapper type="zoom" duration={0.4}>
              <div className="flex flex-col items-center justify-center py-16 sm:py-24 text-gray-500 bg-[#1C1C1E] border border-[#2C2C2E] rounded-2xl">
                ...
                <p className="text-xs sm:text-sm mt-1 text-gray-400">
                  Try adjusting your category or sidebar filters.
                </p>
                <button
                  onClick={handleReset}
                  className="mt-4 px-4 py-2 bg-primary hover:bg-primary text-black font-semibold text-xs rounded-xl transition-all cursor-pointer"
                >
                  Reset Filters
                </button>
              </div>
    ...
    <div className="bg-[#1C1C1E] border border-[#2C2C2E] rounded-2xl p-5 sm:p-6">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <div className="relative">
          <input
            ...
            className="w-full bg-transparent border border-[#E78F23]/20 rounded-lg pl-10 pr-4 py-2 sm:py-2.5 text-sm text-white focus:outline-none focus:border-primary transition-colors"
          />
          ...
          {categoriesList.map((cat) => (
            <button
              ...
              className={`text-left px-3 sm:px-4 py-2 rounded-lg text-sm transition-all cursor-pointer ${
                activeCategory === cat
                  ? "bg-[#2C2C2E] text-primary font-semibold"
                  : "text-gray-400 hover:text-white hover:bg-white/5"
              }`}
            >
              {cat}
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <input
          ...
          className="w-full bg-transparent border border-[#E78F23]/20 rounded-lg px-3 sm:px-4 py-2 sm:py-2.5 text-sm text-white focus:outline-none focus:border-primary transition-colors"
      ...
      {/* Price Range */}
      <div className="mb-2">
        <label className="block text-sm font-medium text-gray-300 mb-5 sm:mb-6">
          Price Range
        </label>
      ...
      <div>
        ...
        <div className="p-4 sm:p-5 relative mt-2">
          ...
          <div className="flex justify-between items-center mb-4 sm:mb-5 gap-2">
            <h4
              className="font-semibold font-inter text-sm sm:text-[15px] truncate text-white"
              title={asset.title}
            >
              {asset.title}
            </h4>
