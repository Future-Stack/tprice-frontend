    ...
    <div className="space-y-8 relative z-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <AnimationWrapper type="fade-right" duration={0.6} delay={0.1}>
          <div
            className="bg-foreground p-7 rounded-2xl border border-primary2/30 shadow-xl hover:border-[#E78F23]/20 transition-colors"
            style={{
              boxShadow:
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="bg-[#D98728] text-white text-[11px] font-bold w-5.5 h-5.5 flex items-center justify-center rounded">
                2
              </span>
            </div>
            ...
            <div className="space-y-6">
              <div className="border-b border-[#2C2C2E]/60 pb-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="bg-green-500/10 text-green-500 text-[11px] px-2.5 py-1 rounded-md font-bold uppercase tracking-wider">
                    Leading
                  </span>
                </div>
              ...
              <div className="pt-2">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="bg-red-500/10 text-red-500 text-[11px] px-2.5 py-1 rounded-md font-bold uppercase tracking-wider">
                    Outbid
                  </span>
                </div>
                <div className="flex justify-between text-[13px] mt-2">
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center border-b border-[#2C2C2E]/60 pb-6">
                <div>
                  <h4 className="font-medium text-gray-200 m-0 text-[20px] mb-2">
                    You placed a bid on Ferrari 488 Spider
                  </h4>
                  <p className="text-[14px] text-gray-300">
                    Your listing for 'Modern Luxury Mansion' is now live
                  </p>
              ...
              <div className="flex justify-between items-center pt-2">
                <div>
                  <h4 className="font-medium text-gray-200 m-0 text-[15px]">
                    Your offer for Patek Philippe was rejected
                  </h4>
                  <p className="text-[13px] text-gray-500 mt-1.5 font-medium">
                    1 day ago
                  </p>
...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <div>
        <div className="text-[40px] font-medium font-clash leading-tight">
          {count}
        </div>
        <div className="text-[24px] text-[#FFFDFD] font-normal mt-0.5">
          {label}
        </div>
      </div>
    </div>
    ...
    <div className="bg-foreground  rounded-[8px] border border-primary2/30 overflow-hidden group hover:border-[#E78F23]/20 transition-all shadow-xl hover:shadow-[#E78F23]/5">
      ...
      <div className="p-5 relative mt-6">
        ...
        <div className="flex justify-between items-center mb-5">
          ...
          <span className="font-normal font-inter text-[17px] text-white">
            {price}
          </span>
        </div>
