...
- **Theme**: Support both light mode and dark mode using `dark:` variants.
- **Palette**: Use curated brand gold tokens (`bg-gold`, `text-gold`, `hover:bg-gold2`, `#DA8708`).
- **Typography**: Use Outfit font for headings (`font-outfit`) and mono font for labels/badges (`font-mono`).
- **Cards**: Modern cards with `rounded-3xl`, subtle borders (`border-slate-200 dark:border-white/10`), and smooth hover micro-animations.
...
- [ ] Are all inputs disabled during mutation loading?
